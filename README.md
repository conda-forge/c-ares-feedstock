...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/c-ares-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/c-ares-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add c-ares c-ares-static
# for installing globally
pixi global install c-ares c-ares-static
```
...
It is possible to list all of the versions of `c-ares` available on your platform:
...
```
pixi search c-ares --channel conda-forge
```
